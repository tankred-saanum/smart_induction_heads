...
for i in range(2):
    ...
    for j in range(3):
        ...
        sub_axes.append(ax)
    right_axes.append(sub_axes)


for metric in ['LM prediction', 'Induction head']:
...
fig.text(0.25, 1.05, 'LM prediction', ha='center', fontsize='x-large')
fig.text(0.75, 1.05, 'Induction heads', ha='center', fontsize='x-large')

left_axes[0][0].set_ylabel('2nd order')
