...
python src/find_learning_heads.py --model_name Qwen/Qwen2.5-7B --markov_order=2 --batch_size=2
python src/find_learning_heads.py --model_name Qwen/Qwen2.5-7B --markov_order=3 --batch_size=2
